        ...
        where TRoleClaimDto : RoleClaimDto<TKey>
{
    ...
    [HttpGet("{id}/Claims")]
    public async Task<ActionResult<RoleClaimsViewModel<TKey>>> GetRoleClaims(string id, int page = 1, int pageSize = 10)
    {
    ...
    [HttpPost("Claims")]
    public async Task<IActionResult> PostRoleClaims([FromBody] RoleClaimViewModel<TKey> roleClaims)
    {
    ...
    [HttpPut("Claims")]
    public async Task<IActionResult> PutRoleClaims([FromBody] RoleClaimViewModel<TKey> roleClaims)
    {
        var roleClaimsDto = _mapper.Map<TRoleClaimsDto>(roleClaims);
