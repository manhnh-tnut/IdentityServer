...
using IdentityServer.Features.IdentityResources.Resources.Interfaces;
...
namespace IdentityServer.Features.IdentityResources.Services;

public class IdentityResourceService : Interfaces.IIdentityResourceService
{
