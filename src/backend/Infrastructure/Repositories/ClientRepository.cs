...
where TDbContext : DbContext, IAdminConfigurationDbContext
{
    ...
    {
        var filteredGrants = Constants.ClientConstants.GetGrantTypes()
    ...
    {
        var signingAlgorithms = Constants.ClientConstants.SigningAlgorithms()
    ...
    {
        return Constants.ClientConstants.GetProtocolTypes();
    }

    public virtual List<SelectItem> GetSecretTypes()
    {
        var secrets = new List<SelectItem>();
        secrets.AddRange(Constants.ClientConstants.GetSecretTypes().Select(x => new SelectItem(x, x)));
    ...
    {
        var filteredClaims = Constants.ClientConstants.GetStandardClaims()
