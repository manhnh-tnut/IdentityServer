...
public class ApiResourceRepository<TDbContext> : Interfaces.IApiResourceRepository
    where TDbContext : DbContext, IAdminConfigurationDbContext
{
    ...
    {
        return AutoSaveChanges ? await DbContext.SaveChangesAsync() : (int)Enums.SavedStatus.WillBeSavedExplicitly;
    }
