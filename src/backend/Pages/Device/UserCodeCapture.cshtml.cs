...
public class UserCodeCaptureModel : PageModel
{
    ...
    private readonly ILogger<UserCodeCaptureModel> _logger;

    public UserCodeCaptureModel(
        IDeviceFlowInteractionService interaction,
        IEventService eventService,
        IOptions<IdentityServerOptions> options,
        ILogger<UserCodeCaptureModel> logger)
    {
    ...
    public async Task<IActionResult> OnPost(string userCode)
    {
        ...
        if (Device == null) return RedirectToPage("~/Error");

        return RedirectToPage("User-Code-Confirmation", Device);
    }
